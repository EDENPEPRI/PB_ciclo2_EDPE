 ...
 * @author Edwin
 */
public class Dueño_MascotaClass {
    ...
    public Dueño_MascotaClass(String nombre_dueño, String tipo_documento, int nro_documento, int telefono, String nombre_mascota) {
    ...
    public String consultar_informacion_dueño(){
        return "  El dueño de  " +getNombre_mascota() + " es " + getNombre_dueño() + " identificado con  " + getTipo_documento() + " numero  " + getNro_documento();
    }
}
